...
"[project]/src/lib/supabase/auth.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function signInWithPassword(email, password) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
        email,
        password
    });
}
async function signOut() {
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signOut();
}
async function getSession() {
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getSession();
}
function onAuthStateChange(callback) {
    // Returns { data: { subscription } }
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.onAuthStateChange((_event, session)=>{
        callback(session);
    });
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
"[project]/src/lib/supabase/storage.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function uploadPartnerLogo(file, slug) {
    ...
    const { error: uploadError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from(BUCKET).upload(path, file, {
        cacheControl: "3600",
        upsert: false,
        contentType: file.type || "application/octet-stream"
    });
    if (uploadError) throw uploadError;
    const { data } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from(BUCKET).getPublicUrl(path);
...
"[project]/src/lib/localDb.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$storage$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/supabase/storage.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$slugify$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/slugify.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$localDb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/localDb.js [app-client] (ecmascript)");
;
...
const ENABLE_LOCAL_ADMIN_FALLBACK = ("TURBOPACK compile-time value", "development") !== "production" && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_ENABLE_LOCAL_ADMIN_FALLBACK !== "false";
...
function AdminPage() {
    ...
    const [isLocalAdmin, setIsLocalAdmin] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [partnerSearch, setPartnerSearch] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const [dataMode, setDataMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("supabase");
    ...
    const switchToLocalMode = (message)=>{
        setDataMode("local");
        setPartners((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$localDb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["readLocalPartners"])());
        setAvailableTags((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$localDb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["readLocalTags"])());
        ...
        try {
            if (dataMode === "local") {
                ...
                if (isEdit) {
                    ...
                    setPartners(updated);
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$localDb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["writeLocalPartners"])(updated);
                    showSuccess("Գործընկերը հաջողությամբ թարմացվեց (local)");
                } else {
                    const next = [
                        {
                            id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$localDb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toLocalId"])("partner"),
                            ...payload,
                            createdAt: Date.now(),
                            updatedAt: Date.now()
                        },
                    ...
                    setPartners(next);
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$localDb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["writeLocalPartners"])(next);
                    showSuccess("Գործընկերը հաջողությամբ ավելացվեց (local)");
                }
                closePartnerModal();
                return;
            }
            if (logoFile) logoUrl = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$storage$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uploadPartnerLogo"])(logoFile, slug);
            const payload = {
                slug,
                name: {
                    am: form.name,
    ...
    const addTag = async ()=>{
        ...
        if (dataMode === "local") {
            const next = [
                ...availableTags,
                {
                    id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$localDb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toLocalId"])("tag"),
                    name: nextName,
                    slug: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$slugify$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["slugify"])(nextName)
                }
            ];
            setAvailableTags(next);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$localDb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["writeLocalTags"])(next);
            setNewTagName("");
    ...
    const saveTagEdit = async ()=>{
        ...
        if (dataMode === "local") {
            const next = availableTags.map((tag)=>tag.id === editingTagId ? {
                    ...
                    slug: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$slugify$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["slugify"])(editingTagName.trim())
                } : tag);
            ...
            if (oldTag && oldTag.name !== newTag) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$localDb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["writeLocalPartners"])(nextPartners);
            }
            setEditingTagId("");
            setEditingTagName("");
    ...
    const removeTag = async (tagId)=>{
        if (dataMode === "local") {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$localDb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["writeLocalTags"])(nextTags);
            if (found) {
                const nextPartners = partners.map((partner)=>({
                        ...partner,
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: [
                    ...
                    ENABLE_LOCAL_ADMIN_FALLBACK ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(AdminPage, "qzP0A5NK4Mx/52AMXheTeP39bYE=");
_c = AdminPage;
var _c;
...
//# sourceMappingURL=src_6e93f06d._.js.map