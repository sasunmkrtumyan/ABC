...
import { createPartner, deletePartner, fetchPartners, updatePartner } from '../../lib/supabase/partners';
import { uploadPartnerLogo } from '../../lib/supabase/storage';
import { createTag, fetchTags } from '../../lib/supabase/tags';
...
export default function AdminPage() {
  const [activeTab, setActiveTab] = useState('add-partner'); // Լռելյայն tab
    ...
    <main className="container-abc py-12">
      ...
      <div className="mb-8 flex items-center justify-between">
        ...
        <div className="gap-3 flex">
          <Link href="/" className="rounded-xl bg-slate-100 flex items-center gap-2 px-4 py-2 font-medium hover:bg-slate-200 transition">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
            Home
          </Link>
          <button onClick={handleLogout} className="rounded-xl border-slate-300 px-4 py-2 hover:bg-red-50 hover:text-red-700 transition border">
            Ելք
          </button>
        </div>
      </div>
